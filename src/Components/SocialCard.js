            ...
            <div id="cardWrapper">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td><img className="postMedia" src={this.state.postMedia} alt="" onClick={ (event) => this.handleLikeChange(event)}></img></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <NavLink to="/post"><button id="viewAllComments" >{"View all " + this.state.commentsTotal + " comments"}</button></NavLink>
                            </td>
                        </tr>
                        <tr>
